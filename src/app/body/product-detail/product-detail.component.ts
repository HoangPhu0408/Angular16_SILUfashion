...
export class ProductDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe((params: Params) => {
      ...
      this.productService
        ...
        .subscribe((prod: any) => {
          this.product = prod;
          this.cateId = prod.categoryId;
          this.productService.getProductByCate(this.cateId).subscribe((relatedProducts: any) => {
            this.relatedProd = relatedProducts;
          });
  ...
  onSubmit(f: NgForm) {
    if (this.authen.customerLoginState == true) {
      const data = {
        userId: this.authen.getCurrentUser(),
